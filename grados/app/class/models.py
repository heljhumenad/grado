...
class StudentClass(models.Model, TimeStampModel):
    class_name = models.CharField(
        max_length=200, verbose_name=_("Name of Class"), blank=False
    )

    class_sched = models.DateTimeField(verbose_name=_("Schedule of class"))

    class_desc = models.CharField(
        max_length=200, verbose_name=_("Description of Class")
    )
    ...
    class_status = models.CharField(
        max_length=200, verbose_name=_("Status of Class"), blank=False
    )
    ...
    updated_by = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, verbose_name=_("Updated By")
    )
