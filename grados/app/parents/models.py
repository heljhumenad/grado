...
class Parent(GradoBasicInfo, GradoAddressInfo, GradoTimeStampModel):
    ...
    occupation = models.CharField(
        max_length=200, verbose_name=_("Occupation"), blank=False
    )

    tel_number = models.CharField(
        max_length=20, verbose_name=_("Telephone Number"), blank=True
    )
    ...
    email_address = models.EmailField(
        max_length=200, verbose_name=_("Email Address"), blank=False
    )
    ...
    legal_guardian = models.BooleanField(
        max_length=10, verbose_name=_("Legal Guardian"), blank=False
    )
